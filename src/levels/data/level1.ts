...
export const level1: LevelData = {
  ...
  solidBlocks: [],
  candles: [
    { position: vec2(376, 512) },
    { position: vec2(248, 512) },
    { position: vec2(504, 512) },
    { position: vec2(632, 512) },
    { position: vec2(760, 512) },
    { position: vec2(888, 512) },
    { position: vec2(1016, 512) },
    { position: vec2(1144, 512) },
    { position: vec2(1272, 512) },
    { position: vec2(1400, 512) },
    { position: vec2(952, 416) },
    { position: vec2(824, 416) },
    { position: vec2(568, 416) },
    { position: vec2(440, 416) },
    { position: vec2(696, 288) },
  ],
  enemies: [
